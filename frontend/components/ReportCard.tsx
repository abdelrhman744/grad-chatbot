...
export default function ReportCard({ report, isArabic }: Props) {
  ...
  return (
    <div
      ...
      className="mt-2 w-full max-w-sm rounded-xl border border-ash bg-white shadow-sm overflow-hidden"
    >
      <div className="flex items-center gap-3 px-4 py-3 border-b border-ash bg-teal/5">
        <div className="w-9 h-9 rounded-lg bg-teal/15 flex items-center justify-center flex-shrink-0">
          <FileText className="w-4.5 h-4.5 text-teal" />
        </div>
      ...
      <div className="px-4 py-3 space-y-2.5">
        ...
        <a
          ...
          download
          className="flex items-center justify-center gap-2 w-full rounded-lg bg-ink text-paper
            text-sm font-medium py-2 hover:bg-ink/80 transition-all"
        >
